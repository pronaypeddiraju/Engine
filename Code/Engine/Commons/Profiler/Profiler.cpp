...
void Profiler::MakeAllocationsWindow()
{
	...
	int returnId = ImGui::PlotHistogram("Allocations view", m_allocArray, m_allocArraySize, 0, "Allocations by each frame", 0, m_maxAlloc, ImVec2((float)clientSize.x - 200.f, 100.f));
