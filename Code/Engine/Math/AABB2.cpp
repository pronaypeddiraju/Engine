...
//------------------------------------------------------------------------------------------------------------------------------
Vec2 AABB2::GetTopLeft2D() const
{
	return Vec2(m_minBounds.x, m_maxBounds.y);
}
...
//------------------------------------------------------------------------------------------------------------------------------
Vec2 AABB2::GetTopRight2D() const
{
	return Vec2(m_maxBounds.x, m_maxBounds.y);
}
...
//------------------------------------------------------------------------------------------------------------------------------
Vec2 AABB2::GetBottomLeft2D() const
{
	return Vec2(m_minBounds.x, m_minBounds.y);
}
...
//------------------------------------------------------------------------------------------------------------------------------
Vec2 AABB2::GetBottomRight2D() const
{
	return Vec2(m_maxBounds.x, m_minBounds.y);
}

//------------------------------------------------------------------------------------------------------------------------------
float AABB2::GetWidth() const
{
	return (m_maxBounds.x - m_minBounds.x);
}

//------------------------------------------------------------------------------------------------------------------------------
float AABB2::GetHeight() const
{
	return (m_maxBounds.y - m_minBounds.y);
}
